...
from LMDrive.leaderboard.autoagents import autonomous_agent
from LMDrive.team_code.planner import RoutePlanner, InstructionPlanner
from LMDrive.team_code.pid_controller import PIDController
...
class LMDriveAgent(autonomous_agent.AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        last_instruction = self._instruction_planner.command2instruct(self.town_id, tick_data,
                                                                      self._route_planner.route)
        ...
        display_data['time'] = 'Time: %.3f. Frames: %d. End prob: %.2f' % (
            timestamp, len(self.visual_feature_buffer), end_prob)
